...
CARDS = {
  'home': dict(out='card.jpg', wordmark='QuotaBird',
    headline=['Carrying a number', 'is hard enough.'],
    dek='Quick reality checks for people who carry a quota. Free, a minute each.',
    foot='No login. No certification. Nothing stored.', url='quotabird.com',
    pillars=['DEAL', 'PIPELINE', 'QUOTA', 'TERRITORY', 'BRIEF']),
  ...
  'pipeline': dict(out='card-pipeline.jpg', wordmark='PIPELINE CHECK',
    ...
    foot='For sales managers. No login. Nothing stored.', url='quotabird.com/pipeline',
